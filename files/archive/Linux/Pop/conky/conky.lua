...
-------------------------------------------------------------------------------
-- Converts Degree to rad and Rotates (0 is on the Top)
--
...
function draw_clock_ring(display, data, value)
	...
	while i <= val do
		cairo_arc(
			...
			y,
			graph_radius,
			(((graph_unit_angle * i) - graph_unit_thickness) * (2 * math.pi / 360)) - (math.pi / 2),
			((graph_unit_angle * i) * (2 * math.pi / 360)) - (math.pi / 2)
		)
	...
	if graduation_radius > 0 and graduation_thickness > 0 and graduation_unit_angle > 0 then
		...
		while i <= nb_graduation do
			...
			cairo_arc(
				...
				y,
				graduation_radius,
				(((graduation_unit_angle * i) - (graduation_mark_thickness / 2)) * (2 * math.pi / 360)) - (math.pi / 2),
				(((graduation_unit_angle * i) + (graduation_mark_thickness / 2)) * (2 * math.pi / 360)) - (math.pi / 2)
			)
