...
This [repository](https://github.com/maydayv7/dotfiles) contains the configuration and `dotfiles` for my continuously evolving multi-PC setup (using [Nix](https://nixos.org/)). You can follow along with my [NixOS Desktop](https://maydayv7.github.io/series/nixos-desktop/) Series
